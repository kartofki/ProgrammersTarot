...
const Footer = () => (
  ...
  <p>
    © {new Date().getFullYear()} Made by kartofki ·{' '}
    <a href="https://github.com/kartofki" target="_blank" rel="noopener noreferrer">
      <svg
      ...
      >
        ...
        0 0 .67-.21 2.2.82a7.63 7.63 0 012.01-.27c.68 0 
        1.36.09 2.01.27 1.53-1.04 2.2-.82 2.2-.82.44 1.09.16 
        1.9.08 2.1.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 
